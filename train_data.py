...
make_train_bin: creates training binary

read_data: a method to read a sequence of data from the training binary,
not mmapped. Mostly for testing.
...
""" NOTE to self: another way of memory mapping
import mmap
import os
